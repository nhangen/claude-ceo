...
4. Always read `Profile/communication.md` for the user's communication style and match it.
5. Read the Altamira discretion constraint in `Profile/discretion.md`. Never include classified or employer-specific details in any writing.

## Writing Process

1. Read the brief or task description.
2. Read `Profile/communication.md` and relevant domain context.
...
8. For cover letters: tailored to the specific role, highlighting relevant experience from `Profile/goals.md`.
